...
<form class="layui-form" id="loginFrm" action="${pageContext.request.contextPath}/login/userLogin" method="post">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/resources/js/cache.js"></script>
