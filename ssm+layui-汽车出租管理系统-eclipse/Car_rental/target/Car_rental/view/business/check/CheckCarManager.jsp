...
layui.use([ 'jquery', 'layer', 'form', 'table','laydate' ], function() {
    ...
    $("#doSearch").click(function(){
        ...
        $.post("${pageContext.request.contextPath}/carCheck/CarRentid",{rentid:rentid},function(obj){
            if(obj===""){
    ...
    function initCheckFromData(rentid){
        $.post("${pageContext.request.contextPath}/carCheck/check",{rentid:rentid},function (obj){
            //检查单
            var check = obj.check;
    ...
    form.on("submit(checkdoSearch)",function () {
           ...
           $.post("${pageContext.request.contextPath}/carCheck/CheckAdd",params,function (obj) {
               layer.msg(obj.msg);
               $("#content").hide();
           })
        return false;
