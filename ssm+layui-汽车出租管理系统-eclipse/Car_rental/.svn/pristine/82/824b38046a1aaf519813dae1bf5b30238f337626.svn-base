    ...
    <form class="layui-form"  lay-filter="dataFrm" id="dataFrm" >
        <div class="layui-col-md12 layui-col-xs12">
            ...
            <div class="layui-form-item magb0">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="isrentiing" value="1" title="已出租">
                    <input type="radio" name="isrentiing" value="0" title="未出租" checked="checked">
                </div>
            </div>
...
layui.use([ 'jquery', 'layer', 'form', 'table','upload'], function() {
        ...
        tableIns=table.render({
            ...
            ,url:'${pageContext.request.contextPath}/car/carList' //数据接口
        ...
        $("#doSearch").click(function(){
            ...
            tableIns.reload({
                url:"${pageContext.request.contextPath}/car/carList?"+params
                ,page:{
                    curr:1
                }
            })
        ...
        table.on('tool(carTable)', function(obj){
            ...
            if(layEvent === 'del'){ //删除
                        layer.confirm('真的删除【'+data.carnumber+'】这个菜单吗', function(index){
                            //向服务端发送删除指令
                            $.post("${pageContext.request.contextPath}/car/CarsDelete.action",{carnumber:data.carnumber},function(res){
                                layer.msg(res.msg);
                                //刷新数据 表格
                                tableIns.reload();
                            })
        ...
        function openAddCar(){
            mainIndex=layer.open({
                ...
                success:function(index){
                    ...
                    $("#showCarImg").attr("src","/CarImg/default.jpg"); //默认显示的汽车图片
                    $('#carimg').val("/CarImg/default.jpg");
                    url="${pageContext.request.contextPath}/car/CarsAdd";
        ...
        function openUpdateCar(data){
            mainIndex=layer.open({
                ...
                success:function(index){
                    ...
                    url="${pageContext.request.contextPath}/car/CarsUpdate.action";
        ...
        function deleteBatch(id){
            ...
            layer.confirm('真的删除选择的这些角色吗', function(index){
                //向服务端发送删除指令
                $.post("${pageContext.request.contextPath}/car/CarsDeleteLot.action",params,function(res){
                    layer.msg(res.msg);
                    //刷新数据 表格
                    tableIns.reload();
                })
