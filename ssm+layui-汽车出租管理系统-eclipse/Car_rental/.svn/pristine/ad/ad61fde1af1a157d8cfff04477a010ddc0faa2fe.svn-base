...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${userPic}" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">管理员:<security:authentication property="principal.username"/></cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="${pageContext.request.contextPath}/login/getUserPer?logname=${userName}" target="All-iframe" data-url=""><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="${pageContext.request.contextPath}/view/system/user/changePwd.jsp" target="All-iframe" data-url=""><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
                        <dd><a href="javascript:;" class="showNotice"><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span class="layui-badge-dot"></span></a></dd>
                        <dd><a href="javascript:;" class="functionSetting"><i class="layui-icon">&#xe620;</i><cite>功能设定</cite><span class="layui-badge-dot"></span></a></dd>
                        <dd><a href="javascript:;" class="changeSkin"><i class="layui-icon">&#xe61b;</i><cite>更换皮肤</cite></a></dd>
                        <dd><a href="javascript:;" class="signOut" id="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <form action="${pageContext.request.contextPath}/logout" method="post" id="Form">
       <security:csrfInput/>
    </form>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="${userPic}" class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
				<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="demo"
					...
					<li class="layui-nav-item layui-nav-itemed layui-icon"><a
						...
						<security:authorize access="hasAnyRole('ROLE_SUPER','ROLE_BUSINESS')">
						<dl class="layui-nav-child">
							<dd>
					...
					<li class="layui-nav-item layui-icon"><a href="javascript:;">&#xe663;业务管理</a>
						...
						<dl class="layui-nav-child">
							...
							<dd>
								<a href="${pageContext.request.contextPath}/view/business/rent/RentNoManager.jsp" target="All-iframe">&#xe6b2;出租单管理</a>
							</dd>
							<dd>
								<a href="${pageContext.request.contextPath}/view/business/check/CheckCarManager.jsp" target="All-iframe">&#xe65a;汽车入库</a>
							</dd>
							<dd>
								<a href="${pageContext.request.contextPath}/view/business/check/CheckManager.jsp" target="All-iframe">&#xe705;检查单管理</a>
							</dd>
						</dl>
						</security:authorize>
				     </li>
				    <li class="layui-nav-item layui-icon"><a href="javascript:;">&#xe716;系统管理</a>
						<security:authorize access="hasAnyRole('ROLE_SUPER','ROLE_SYS')">
						<dl class="layui-nav-child">
							<dd>
				     ...
				     <li class="layui-nav-item layui-icon"><a href="javascript:;">&#xe629;统计分析</a>
						<security:authorize access="hasAnyRole('ROLE_SUPER','ROLE_DATA')">
						<dl class="layui-nav-child">
							<dd>
								<a href="${pageContext.request.contextPath}/view/stat/CustomerAreaStat.jsp" target="All-iframe">&#xe63c;客户地区统计</a>
							</dd>
							<dd>
								<a href="${pageContext.request.contextPath}/view/stat/componyYearGradeStat.jsp" target="All-iframe">&#xe62c;公司年度月份销售额</a>
							</dd>
							<dd>
								<a href="${pageContext.request.contextPath}/view/stat/opernameYearGradeStat.jsp" target="All-iframe">&#xe62d;业务员年度销售额</a>
							</dd>
						</dl>
						</security:authorize>
				    </li>
