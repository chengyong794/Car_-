            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="${pageContext.request.contextPath}/login/getUserPer?logname=${userName}"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="${pageContext.request.contextPath}/view/system/user/changePwd.jsp"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
...
<script type="text/javascript">
    ...
    $("body").on("click","#unlock",function(){
        if($(this).siblings(".admin-header-lock-input").val() == ''){
            ...
            if($(this).siblings(".admin-header-lock-input").val() == ${userName}){
